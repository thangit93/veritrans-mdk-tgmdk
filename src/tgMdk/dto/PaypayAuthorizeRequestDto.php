...
class PaypayAuthorizeRequestDto extends AbstractPaymentRequestDto
{
     ...
     * serviceOptionType="online"（オンライン決済）    ： 指定任意※1<br/>
     * 　　（エージェント接続） ： 指定任意<br/>
     * 　　（PayPay直接接続） ： 指定任意（※2）<br/>
     * ※1 オンライン決済で未指定の場合、"0"(都度決済)になります。<br/>
     * ※2 onlinePaymentType="1"（スマートペイメント）の場合、指定可能な値は"0"(都度決済)のみになります。<br/>
     */
     ...
     * serviceOptionType="online"（オンライン決済）（※2）<br/>
     * 　　（エージェント接続） ： 指定できません（※3）<br/>
     * 　　（PayPay直接接続） ： 指定任意（※4）<br/>
     * <br/>
     * ※1 指定可能な値は"true"のみ。未指定の場合は、"true"を設定します。<br/>
     * ※2 accountingType="1"（随時決済）で指定があった場合には指定値を無視して処理します。<br/>
     * ※3 指定があった場合には指定値を無視して処理します。<br/>
     * ※4 未指定の場合は、"false"を設定します。 onlinePaymentType="1"（スマートペイメント）で指定があった場合には指定値を無視して処理します。<br/>
     */
    private $withCapture;
     ...
     * <br/>
     * serviceOptionType="barcode"（バーコード決済） ： 指定必須<br/>
     * serviceOptionType="online"（オンライン決済）<br/>
     * 　　（エージェント接続） ： 指定できません<br/>
     * 　　（PayPay直接接続） ： 指定任意<br/>
     */
    private $storeId;
     ...
     * ※onlinePaymentType="1"（スマートペイメント）の場合は指定任意<br/>
     */
    private $itemId;
     ...
     * serviceOptionType="barcode"（バーコード決済） ： 指定できません<br/>
     * serviceOptionType="online"（オンライン決済）    ： 指定任意※<br/>
     * ※onlinePaymentType="1"（スマートペイメント） ： 指定できません<br/>
     ...
     * 半角英数字<br/>
     * 最大桁数：1<br/>
     * 決済処理で接続する決済事業者を指定します。<br/>
     * - 0 : エージェントへ接続<br/>
     * - 1 : PayPayへ直接接続<br/>
     * <br/>
     * serviceOptionType="barcode"（バーコード決済） ： 指定できません<br/>
     * serviceOptionType="online"（オンライン決済）    ： 指定任意※<br/>
     * ※未指定の場合は、加盟店登録設定で有効になっている決済事業者に接続します。<br/>
     */
    private $provider;
     ...
     * serviceOptionType="online"（オンライン決済）<br/>
     * 　　（エージェント接続） ： 指定できません<br/>
     * 　　（PayPay直接接続） ： 指定任意（※1）<br/>
     * ※1 指定可能な値は"1"（スマートペイメント）のみ。<br/>
     */
    ...
    /**
     * 接続先事業者を設定する<br>
     * @param string $provider 接続先事業者<br>
     */
